...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      JI: a => a.pop(),
      JJ: (x0,x1) => x0.revokeObjectURL(x1),
      ...
      LH: x0 => x0.status,
      LI: (map, o) => map.get(o),
      LJ: (x0,x1,x2,x3,x4) => globalThis.createImageBitmap(x0,x1,x2,x3,x4),
      ...
      RJ: (x0,x1) => x0.createObjectURL(x1),
      ...
      UI: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      ...
      VI: (x0,x1) => globalThis.fetch(x0,x1),
      ...
      kJ: () => globalThis.window.ImageDecoder,
      ...
      nH: x0 => x0.wasmMemory,
      nI: (x0,x1,x2) => x0.insertRule(x1,x2),
      nJ: x0 => x0.naturalHeight,
      ...
      qI: (x0,x1,x2) => x0.addEventListener(x1,x2),
      qJ: (x0,x1) => { x0.src = x1 },
      qK: x0 => x0.length,
      r: (x0,x1) => x0.focus(x1),
      ...
      zI: x0 => x0.offsetY,
      zJ: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
