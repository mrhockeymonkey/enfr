...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      LJ: x0 => x0.button,
      LK: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      M: o => String(o),
      ...
      VI: () => new WeakMap(),
      VJ: (x0,x1) => x0.revokeObjectURL(x1),
      ...
      XH: x0 => x0.next(),
      XI: x0 => x0.deref(),
      XJ: (x0,x1,x2,x3,x4) => globalThis.createImageBitmap(x0,x1,x2,x3,x4),
      XK: x0 => x0.repeat,
      Y: (o0, o1) => [o0, o1],
      YB: (t, s) => t.set(s),
      ...
      ZJ: x0 => x0.naturalWidth,
      ZK: (x0,x1) => x0.getRandomValues(x1),
      ...
      aJ: x0 => x0.decode(),
      aK: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      b: (x0,x1,x2) => { x0[x1] = x2 },
      bB: o => {
        if (o === null || o === undefined) return 0;
      ...
      cJ: (x0,x1) => { x0.crossOrigin = x1 },
      cK: x0 => x0.localStorage,
      d: (o, p) => o[p],
      dB: o => {
        if (o === null || o === undefined) return 0;
      ...
      dJ: (x0,x1) => x0.createObjectURL(x1),
      dK: x0 => x0.sessionStorage,
      e: () => globalThis,
      ...
      gH: x0 => x0.done,
      gI: (x0,x1) => x0.get(x1),
      gJ: (x0,x1,x2,x3,x4) => ({type: x0,data: x1,premultiplyAlpha: x2,colorSpaceConversion: x3,preferAnimation: x4}),
      gK: (x0,x1) => x0.getItem(x1),
      ...
      hJ: x0 => new window.ImageDecoder(x0),
      hK: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      i: (l, r) => l === r,
      ...
      iJ: x0 => x0.name,
      iK: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      j: x0 => x0.random(),
      ...
      jI: x0 => x0.statusText,
      jJ: x0 => x0.repetitionCount,
      jK: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      k: o => o,
      ...
      kI: x0 => x0.url,
      kJ: x0 => x0.frameCount,
      kK: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      l: o => {
        if (o === undefined || o === null) return 0;
      ...
      lH: x0 => x0.Segmenter,
      lI: x0 => x0.status,
      lJ: x0 => x0.selectedTrack,
      lK: (x0,x1,x2) => x0.exportKey(x1,x2),
      m: () => globalThis.Math,
      ...
      pI: x0 => x0.value,
      pJ: x0 => x0.close(),
      pK: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      ...
      qI: x0 => x0.done,
      qJ: (x0,x1) => ({frameIndex: x0,completeFramesOnly: x1}),
      qK: x0 => x0.length,
      r: (x0,x1) => x0.focus(x1),
      ...
      wI: (x0,x1) => x0.append(x1),
      wJ: () => globalThis.window.ImageDecoder,
      wK: (x0,x1) => new OffscreenCanvas(x0,x1),
      ...
      xH: x0 => x0.id,
      xI: (x0,x1,x2) => x0.insertRule(x1,x2),
      xJ: (o, p) => p in o,
      xK: x0 => x0.assetBase,
      ...
      zJ: x0 => x0.naturalHeight,
      zK: () => globalThis._flutter,
