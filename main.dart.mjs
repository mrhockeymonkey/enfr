...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      rJ: (x0,x1,x2) => x0.insertBefore(x1,x2),
      rK: x0 => x0.getReader(),
      s: () => ({}),
